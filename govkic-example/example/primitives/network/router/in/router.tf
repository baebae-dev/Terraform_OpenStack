...
#    openstack_networking_router_interface_v2.router_interface_a,
#    openstack_networking_router_interface_v2.router_interface_b,
#    openstack_networking_port_v2.port_a,
#    openstack_networking_port_v2.port_b
#  ]
}